...
We now have Assistant-like and Thread-like objects in the Responses API. Learn more in the [migration guide](/docs/guides/assistants/migration). As of August 20th, 2025, we're deprecating the Assistants API, with a sunset date of July 1, 2026.
